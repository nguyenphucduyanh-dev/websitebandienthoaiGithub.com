...
<body>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Guest List GEMINI</h1>
				...
				<?php while($row = $result->fetch_assoc()): ?>
					<div class="col-md-4">
						<div class="card mb-4 shadow-sm">
							<?php 
								$imagePath = !empty($row['avatar']) ? $row['avatar'] : 'assets/img/default-avatar.png';
							?>
							<a href="user-detail.php?username=<?= $row['username'] ?>">
								<img class="bd-placeholder-img card-img-top" width="100%" height="350"
									 src="<?= $imagePath ?>" style="object-fit: cover;">
							</a>
